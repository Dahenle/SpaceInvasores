...
public class Test extends javax.swing.JFrame {
    ...
    int puntaf,puntad,puntam;
    public Test(String nombre, String nave,int puntaf,int puntam,int puntad) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        Facil facil = new Facil(navecita1,nombre,1000,"uno", 0, 2, 3,puntaf,puntam,puntad, 1);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        this.dispose();
        Facil facil = new Facil(navecita1,nombre, 600,"dos", 0, 3, 2,puntaf,puntam,puntad, 1);
        facil.setResizable(false);
        facil.setSize(715,520);
        facil.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.dispose();
        Facil facil = new Facil(navecita1,nombre, 600,"tres", 0, 4, 1,puntaf,puntam,puntad, 1);
        facil.setResizable(false);
        facil.setSize(715,520);
        facil.setVisible(true);
